...
try {
    ...
    elseif ($DeploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path '$Env:ProgramFiles\Mozilla Firefox\uninstall\helper.exe' -Parameters '/S' -ContinueOnError
        Remove-MSIApplications -Name 'Mozilla Firefox' -ContinueOnError
