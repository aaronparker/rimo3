...
function Install-ADTDeployment
{
        ...
        $params = @{
            ...
            ArgumentList = "DESKTOP_SHORTCUT=false TASKBAR_SHORTCUT=false"
            PassThru = $true
        }
...
function Uninstall-ADTDeployment
{
        ...
        Start-ADTProcess -FilePath '$Env:ProgramFiles\Mozilla Firefox\uninstall\helper.exe' -ArgumentList '/S'
